...
class AddStaffDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent, api_client: ApiClient, on_success):
        ...
        # Header
        ctk.CTkLabel(self.main_frame, text="👔 Yeni Personel Ekle", 
    ...
    def save(self):
        ...
        if not all([first_name, last_name, email, password, role]):
            messagebox.showwarning("Eksik Bilgi", 
                "Lütfen Ad, Soyad, Email, Şifre ve Rol alanlarını doldurunuz.")
            return
        ...
        try:
            ...
            messagebox.showerror("Hata", f"Personel oluşturulamadı: {e}")
