...
class UpdateMemberDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent, api_client: ApiClient, member_data: dict, on_success):
        ...
        # Header
        ctk.CTkLabel(self.main_frame, text=_("✏️ Bilgileri Düzenle"), 
    ...
    def save(self):
        ...
        if not all([first_name, last_name, email]):
            messagebox.showwarning(_("Eksik Bilgi"), 
                _("Lütfen Ad, Soyad ve Email alanlarını doldurunuz."))
            return
        ...
        try:
            ...
            messagebox.showerror(_("Hata"), _("Güncelleme hatası: {error}").format(error=e))
